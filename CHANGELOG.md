...
> AgentLens 1.0 Alpha 的当前实现与自动验收状态见 [`docs/1.0/IMPLEMENTATION-STATUS.md`](docs/1.0/IMPLEMENTATION-STATUS.md)。本文件以下内容继续保留 0.x 历史发布记录；1.0 正式发布条目将在实际发布时补充。
...
### Fixed
- Windows 安装、升级、PATH 更新和原生依赖处理和服务管理涉及的子进程统一隐藏窗口，避免安装过程中反复闪现控制台。
