...
if (!/rounds\.map/.test(page) || !/<VirtualRoundMount/.test(page) || !/projectLiveTaskRounds/.test(page)) throw new Error('Generic Live semantic round virtualization is missing')
