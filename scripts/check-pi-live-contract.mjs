...
requireText(page, /const headerTitle = taskDetailModel\.title\.replace/, 'Pi Live Header 标题必须基于 TaskDetailModel 进行来源后缀去重')
requireText(page, /title=\{headerTitle\}/, 'Pi Live Header 必须使用去重后的 TaskDetailModel 标题')
