...
requireText(page, /historyRounds\.map[\s\S]{0,720}<PiLiveHistoryTaskRound/, '历史轮次必须通过 PiLiveHistoryTaskRound')
...
requireText(piTaskRound, /streamText && <div className="pi-live-stream-response"/, 'Streaming Tail 必须保持独立实时渲染')
