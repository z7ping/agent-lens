...
requireText(piTaskRound, /export function PiLiveHistoryTaskRound[\s\S]{0,3600}<HistoryToolGroup/, 'Pi Live 历史 Tool 必须通过 HistoryToolGroup Adapter 渲染')
requireText(piTaskRound, /function HistoryToolGroup[\s\S]{0,1400}<TaskToolGroup/, 'Pi Live 历史 Tool Adapter 必须统一进入 TaskToolGroup')
