...
requireText(taskCenter, /nativeDirectoryPicker && <Button[\s\S]{0,300}selectDirectoryAndStart/, '桌面主流程必须优先使用原生目录选择器')
...
requireText(piComposer, /uploadLiveAttachment\(item\.file\)/, 'Live Composer 图片必须先进入通用 Attachment Service')
