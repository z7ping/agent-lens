...
if (!backupPage.includes('<span className="prototype-flag live">{t(\'page.liveData\')}</span>')
  || !officialZhCn.includes("liveData: '本地真实数据'")) {
  throw new Error('资产备份必须保留国际化“本地真实数据”状态标识')
}
