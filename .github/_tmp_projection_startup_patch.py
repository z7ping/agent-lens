...
# 1) Core contracts: projection flush + cheap materialization availability check.
replace_once(
...
# 3) SQLite projection guard.
replace_once(
    'packages/storage-sqlite/src/session-summaries.ts',
...
print('Projection startup patch applied')
