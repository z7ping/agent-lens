...
export interface IntegrationPreferencesDto {
  ...
  /** Effective global order used across AgentLens product surfaces. */
  displayOrder: string[]
  /**
   * False means displayOrder is still the official default and a legacy Web
   * preference may be migrated exactly once without overwriting user settings.
   */
...
export interface IntegrationPreferenceUpdateRequestDto {
  /** Onboarding completion is monotonic; false is intentionally unsupported. */
