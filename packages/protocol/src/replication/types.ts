...
export interface EntityVersionSupport { entityType: string; versions: readonly number[] }
...
export interface NodeEntityRef { kind: 'node'; entityType: string; originEntityId: string }
export interface SharedEntityRef { kind: 'shared'; entityType: 'AgentProduct'; sharedKey: string }
