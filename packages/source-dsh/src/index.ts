...
import { dshManifest, dshSourceDefinition } from './source'
...
export const dshSourcePlugin = defineAgentLensPlugin(dshManifest, applyProfiledDshSource)

export const dshProfileInternals = {
  detectProfiledDsh,
  profileContext,
}
