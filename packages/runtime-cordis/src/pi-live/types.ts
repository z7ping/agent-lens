import type { LiveAvailability, LiveHistoryIndex, LiveMessageActionContribution, LiveMessageActionResult, LiveRuntimeActionResult, LiveRuntimeDisclosureContribution, LiveRuntimeEvent, LiveRuntimeState, LiveSnapshot, LiveSnapshotWindow, LiveThinkingControl, LiveWorkspaceFileReference } from '@agent-lens/core'
...
export interface PiLiveService {
  ...
  runtimeDisclosures(runtimeSessionId: string): Promise<LiveRuntimeDisclosureContribution[]>
  executeRuntimeAction(runtimeSessionId: string, actionId: string): Promise<LiveRuntimeActionResult>
