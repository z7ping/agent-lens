...
export const englishTaskMessages: LocaleMessagesDto = {
  task: {
    ...
    live: {
      ...
      loadingTitle: 'Loading live task',
      loadingDescription: 'Reading runtime state and session content…',
    ...
    center: {
      ...
      runtimeDisclosure: {
        ...
        preparing: 'Preparing',
        startupStages: 'Runtime startup stages',
        waiting: 'Waiting',
        runtimeResources: 'Runtime resources',
        startupTiming: 'Runtime startup timing',
