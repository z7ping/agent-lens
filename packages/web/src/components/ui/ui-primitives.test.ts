...
test('Live Runtime keeps lifecycle in Reader and exposes fully expanded copyable diagnostics', () => {
  ...
  assert.match(liveRuntimeDisclosures, /lifecycle\.stages\.map/)
  assert.match(liveRuntimeDisclosures, /lifecycle\.resources/)
  ...
  assert.match(liveRuntimeDisclosures, /copyText\(value\)/)
  assert.match(liveRuntimeDisclosures, /className="live-runtime-diagnostic-resource-group"/)
  assert.match(liveRuntimeDisclosures, /className="live-runtime-diagnostic-code-groups"/)
  assert.doesNotMatch(liveRuntimeDisclosures, /<Disclosure/)
  assert.match(piLiveCss, /\.live-runtime-disclosures\s*\{/)
  assert.match(piLiveCss, /\.live-runtime-diagnostics-dialog \.ui-overlay-body/)
  ...
  assert.doesNotMatch(piLiveCss, /live-runtime-task-info|live-runtime-info-section|task-header-info-content/)
