...
test('Live Runtime keeps lifecycle in Reader and opens full diagnostics in shared Dialog', () => {
  ...
  assert.match(liveRuntimeDisclosures, /import \{ Button, Dialog, Disclosure, UiIcon \} from '\.\/ui'/)
